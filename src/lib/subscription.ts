...
/** Precio "de lista" del año: 12 meses al valor mensual, SIN descuento. Se
 *  muestra tachado junto al precio real para que se vea que el anual ya
 *  viene rebajado. */
export const ANNUAL_LIST_PRICE_CLP = SUBSCRIPTION_PRICE_CLP * 12;
/** Cuánto ahorra el cliente pagando anual vs. 12 meses mensuales, en CLP. */
export const ANNUAL_SAVINGS_CLP = ANNUAL_LIST_PRICE_CLP - SUBSCRIPTION_PRICE_ANNUAL_CLP;
